...
public class GeneratedFileWriter {
     ...
     * @return
     */
    public static Builder builder(String finalPath, String resourcesDirectoryProperty, String sourcesDirectoryProperty, String scaffoldedSourcesDir) {
     ...
     * @return
     */
    static Builder builder(String finalPath, String resourcesDirectoryProperty, String sourcesDirectoryProperty, String scaffoldedSourcesDir, AppPaths.BuildTool buildTool) {
